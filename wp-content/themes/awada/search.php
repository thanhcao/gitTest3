...
<section class="post-wrapper-top section-shadow clearfix">
	<div class="container">
		<div class="col-lg-12">
			<h2><?php printf(__("Search Results For: \"%s\"", 'awada'), '<span>' . esc_attr(get_search_query()) . '</span>'); ?></h2>
				...
				while (have_posts()):
					...
					wp_link_pages(); } else { ?>
                        <div class="search_error">
                            <div class="search_err_heading"><h2><?php _e("Nothing Found", 'awada'); ?></h2>
                            </div>
                            <div class="awada_searching">
                                <p><?php _e("Sorry, but nothing matched your search criteria. Please try again with some different keywords.", 'awada'); ?></p>
                            </div>
                        </div>
                        <?php get_search_form(); ?>
                    <?php } ?>
